...
class ValidationConfig:
    ...
    known_metric_keys: FrozenSet[str] = field(
        default_factory=lambda: frozenset({
            ...
            "links.external", "images", "image_count", "missing_alt_percent",
            "meta", "meta.title", "meta.description",
            "page_type_hint",
            "h2_texts", "h3_texts", "cta_texts", "main_text_excerpt",
            # Advanced diagnostics
            "advanced", "advanced.load_time_ms", "advanced.status_code",
            "advanced.dom_elements", "advanced.inline_styles",
            "advanced.external_stylesheets", "advanced.external_scripts",
            "advanced.forms", "advanced.videos", "advanced.aria_roles",
            "advanced.social_links", "advanced.https", "advanced.favicon",
            "advanced.html_lang", "advanced.unlabelled_inputs",
        })
    )
