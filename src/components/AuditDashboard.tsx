...
/**
 * Bridge the existing AuditResult.metrics shape to the
 * FactualMetricsData shape consumed by FactualMetricsSection.
 */
function toFactualMetrics(result: AuditResult): FactualMetricsData {
  ...
  return {
    ...
    // Advanced diagnostics are not currently in AuditResult —
    // they will appear here once the backend extractor produces them.
    // advanced: { ... }
  };
}
